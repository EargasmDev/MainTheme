...
initZoom();
 ...
 };						cb.bind($('section[data-section-id="mseabbhpvs"] include[data-name="product-images"][data-id="1"]').get(0))(jQuery);;var cb  = function($) {
...
$txt.on('time.elapsed', function () {
 ...
 };						cb.bind($('section[data-section-id="mseabbhpvs"] include[data-name="countdown"][data-id="3"]').get(0))(jQuery);;var cb  = function($) {
...
var current_variant = null;
 ...
 };						cb.bind($('section[data-section-id="mseabbhpvs"] include[data-name="product-form"][data-id="4"]').get(0))(jQuery);;var cb  = function($) {
...
initZoom();
 ...
 };						cb.bind($('section[data-section-id="mseabbhpvs"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="mseabbhpvs"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/7X2dkGaNmzMbZPsC/product/",						settings: {"use_zoom":"no","cd_text_expire":"EXPIRED TIME","day":"","hour":"","min":"","sec":"","trans_unavai":"Unavailable","trans_outstock":"Out of stock","trans_sale":"Sale "}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "7744avqeu2m"							}), success: c, error: e});						}, cb  = function(section, $) {window.HUB = window.HUB || {};
...
initZoom();
 ...
 };						cb.bind($('section[data-section-id="7744avqeu2m"] include[data-name="product-images"][data-id="1"]').get(0))(jQuery);;var cb  = function($) {
...
$txt.on('time.elapsed', function () {
 ...
 };						cb.bind($('section[data-section-id="7744avqeu2m"] include[data-name="countdown"][data-id="3"]').get(0))(jQuery);;var cb  = function($) {
var _this = jQuery(this),
		$this = jQuery(_this).closest('.lh-product-single'),
		slide = jQuery($this).find('.block-slide-lg'),
		thumb = jQuery($this).find('.block-slide-sm'),
...
var current_variant = null;
 ...
 };						cb.bind($('section[data-section-id="7744avqeu2m"] include[data-name="product-form"][data-id="4"]').get(0))(jQuery);;var cb  = function($) {
	if(document.querySelector('.page-container') && window.getComputedStyle(document.querySelector('.page-container')).transform.indexOf('matrix') != -1){
		document.querySelector('.page-container').style.webkitTransform='none';
		document.querySelector('.page-container').style.transform='none';
	}
...
initZoom();
 ...
 };						cb.bind($('section[data-section-id="7744avqeu2m"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="7744avqeu2m"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/7X2dkGaNmzMbZPsC/product/",						settings: {"use_zoom":"no","cd_text_expire":"EXPIRED TIME","day":"","hour":"","min":"","sec":"","trans_unavai":"Unavailable","trans_outstock":"Out of stock","trans_sale":"Sale "}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "lcc4viby2l9"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="lcc4viby2l9"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/aYTsdxBNQqI4tloZ/call_to_action/",						settings: {}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "u95s1oquqa"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="u95s1oquqa"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/aYTsdxBNQqI4tloZ/call_to_action/",						settings: {}					}, jQuery);})(jQuery);;console.log('This page layout has been built by https://www.layouthub.com');