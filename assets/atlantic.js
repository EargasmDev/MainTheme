...
var fitvids = __webpack_require__(4);
...
var CartMini_CartMini = /*#__PURE__*/function () {
  ...
  CartMini_createClass(CartMini, [{
    ...
    value: function open() {
      ...
      if (!this.data) return;
      components_SidebarDrawer.open(this.data).then(function (container) {
        _this.events.register(container, 'click', function (e) {
          if (!e.target.matches('[data-cart-mini-item-remove]')) return;

          _this.removeItem(e.target.closest('[data-cart-mini-item]'));
    ...
    value: function removeItem(lineItem) {
      ...
      var key = lineItem.dataset.cartMiniItem;
    ...
    value: function refresh() {
      ...
      var $deferred1 = jquery_default.a.get(jsonUrl, function (data) {// Bold:PO
  ...
  Product_createClass(Product, [{
    ...
    value: function setupVariants() {
      ...
      var selectedVariant = function selectedVariant() {
        return _this2.variantHelpers ? _this2.variantHelpers.getSelectedVariant() : _this2.data.product.variants[0];
      ...
      this.surfacePickUp.onModalRequest(function (content) {
        var variantTitle = _this2.variantHelpers ? "<div class=\"sidebar-drawer__surface-pick-up-variant\">".concat(selectedVariant().title, "</div>") : '';
    ...
    value: function handleErrors(response) {
      ...
      this.timeout = setTimeout(function () {
        ...
        _this3.addToCartButton.setState('error');

        setTimeout(function () {
          return _this3.addToCartButton.resetState();
        }, 1000);
      }, 1000);
    }
  }, {
    ...
    value: function addToCart() {
      ...
      jquery_default.a.ajax({
        ...
        success: function success() {
          if (_this4.data.settings.enable_cart_redirect) {
            window.location = window.Theme.routes.cart_url;
            return;
          }

          _this4.cartMini.refresh();

          _this4.timeout2 = setTimeout(function () {
            _this4.addToCartButton.setState('success');

            _this4.cartMini.open();

            _this4.timeout3 = setTimeout(function () {
              _this4.addToCartButton.resetState();
...
//       });
  ...
  if (document.querySelector('.mw-apo-container')) {
    document.querySelector('form[data-product-form]').submit()
  } else {
    event.preventDefault();
...
window._usfState = state;
window._usfSections = new shopify_sections_manager_es();
window._usfStaticCollection_StaticCollection = StaticCollection_StaticCollection;
...
/***/ })
/******/ ]);
//# sourceMappingURL=atlantic.js.map?1612908314243